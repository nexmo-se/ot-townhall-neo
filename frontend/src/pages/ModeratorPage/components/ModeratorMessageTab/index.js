...
import ExperienceRendererPanel from '../ExperienceRendererPanel';
  ...
  return (
    <Tab className={mStyles.root}>
      <TabHeader>
        ...
        <TabItem
          isActive={activeTab === 'experience-composer'}
          onClick={() => setActiveTab('experience-composer')}
        >
          Experience Composer
        </TabItem>
      </TabHeader>
      <TabContent>
        {display.chat && (
          <TabPanel isActive={activeTab === 'chats'}>
            <Chat
              me={me ?? new User({ name: 'System', role: 'system' })}
              autoScroll={false}
            />
          </TabPanel>
        )}
        ...
        <TabPanel isActive={activeTab === 'experience-composer'}>
          <ExperienceRendererPanel />
        </TabPanel>
      </TabContent>
    </Tab>
  );
